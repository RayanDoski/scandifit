...
def schedual():
    ...
    amount_of_exercises_per_week = amount_per_week(tp[8])

    # Users Situation (Gym Or Home | Equiptment Access)
    thier_situation = your_situation(tp[10], tp[11])
    ...
    cardio_training_list = cardio_exercises(tp[10], tp[11], tp[2], cardio_exercise)
