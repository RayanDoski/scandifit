...
document.getElementById('form-quiz').addEventListener('submit', function(event) {
    ...
    let form_validation_namn = document.querySelector('#name');
    let form_validation_email = document.querySelector('#email');
    let form_validation_pass = document.querySelector('#pass');

    if (form_validation_namn && form_validation_email && form_validation_pass) {
        // Elements exist, retrieve their values
        form_validation_namn = form_validation_namn.value;
        form_validation_email = form_validation_email.value;
        form_validation_pass = form_validation_pass.value;
    }
